...
namespace ExampleFactoryTests
{
    public class FactoryMethodTests
    {
        ...
        [Test]
        public void CreateWrongByFactoryMethod_CheckIfCorrectExampleId()
        {
            //Arrange
            (MyId? id, string? errorMsg) result;
    ...
    {
        [Test]
        public void CreateGoodByFactoryClass_CheckIfCorrectExampleId()
        {
            //Arrange
            MyId id;
